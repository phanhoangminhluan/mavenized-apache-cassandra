...
//                System.out.println("------------------------------------------------ readCommitLogSegment ------------------------------------------------");
//                System.out.println("desc.id: " + desc.id);
//                System.out.println("desc.fileName(): " + desc.fileName());
//                System.out.println("desc.toString(): " + desc.toString());
//                System.out.println("------------------------------------------------ DONE readCommitLogSegment ------------------------------------------------");
            }
            catch (Exception e)
            {
                desc = null;
...
//                if (upd.metadata().keyspace.equals("cmie")) {
//                    System.out.println("------------------------------------------------ readMutation ------------------------------------------------");
//                    System.out.println("mutation.trackedByCDC(): " + mutation.trackedByCDC());
//                    System.out.println("upd.metadata().name: " + upd.metadata().name);
//                    System.out.println("upd.metadata().params.toString(): " + upd.metadata().params.toString());
//                    System.out.println("upd.operationCount(): " + upd.operationCount());
//                    System.out.println("upd.rowCount(): " + upd.rowCount());
//                }
//
//                for (Row row : upd)
//                {
//                    upd.metadata().comparator.validate(row.clustering());
//
//                    for (ColumnData cd : row) {
//                        if (upd.metadata().keyspace.equals("cmie")) {
//                            try {
//                                System.out.println("============== cell ==============");
//                                Cell cell = upd.getRow(row.clustering()).getCell(cd.column());
//                                Object o = cd.column().cellValueType().getSerializer().deserialize(cell.value(), cell.accessor());
//                                System.out.println("Cell Column: " + cell.column().toString());
//                                System.out.println("Cell Data Type: " + cd.column().cellValueType().getClass().getSimpleName());
//                                System.out.println("Cell Java Class: " + o.getClass().getSimpleName());
//                                System.out.println("Cell Value: " + o);
//
//                                System.out.println("============== DONE cell ==============");
//
//                            } catch (Exception e) {
//                                System.out.println("Cac loi. Exception: " + e.getMessage());
//                            }
//                        }
//                        cd.validate();
//                    }
...
//                }
//                if (upd.metadata().keyspace.equals("cmie")) {
//                    System.out.println("------------------------------------------------ DONE readMutation ------------------------------------------------");
//                }
                upd.validate();
            }
        }
